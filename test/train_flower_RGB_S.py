...
# build model
I3D = model.InceptionI3d((64, 224, 224, 3), NUM_CLASSES)
...
# checkpoint
checkpoint_dir = './checkpoints/mnist_rgb_scratch/'
...
for epoch in range(_EPOCH):
    # train
    for i, (videos, labels) in enumerate(train_ds):
    ...
    # validation
    for i, (videos, labels) in enumerate(validation_ds):
